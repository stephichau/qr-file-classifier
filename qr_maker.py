...
def parse_arguments():
    ...
    parser.add_argument('-n', "--file", action="store", dest="file_data",help="File where data is stored in JSON format")
    return parser.parse_args()


# Version 0
QR_DIRECTORY_PATH = '{}/QR/'.format(os.path.abspath('.'));
print(QR_DIRECTORY_PATH)
...
def main():
    ...
    if not (arguments.course_name and arguments.section_number and arguments.year_number and
    ...
    elif arguments.file_data and not (arguments.course_name and arguments.section_number and arguments.year_number and
